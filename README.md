...
- O usuário precisa confirmar sua senha ao resetá-la;
...
- O usuário deve poder listar os dias de um mês com pelo ao menos um horário disponível de um prestador;
